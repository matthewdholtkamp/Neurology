...
**One-liner:** blood in the subarachnoid space, usually from a **ruptured saccular aneurysm** —
the classic **thunderclap "worst headache of my life."** Two battles, weighted equally: **secure the
aneurysm fast** (it re-bleeds and kills), then **survive the next two weeks** of delayed cerebral
ischemia, hydrocephalus, and hyponatremia in a neuro-ICU.

!!! danger "🚩 Thunderclap headache = SAH until excluded"
    - **Sudden, severe, maximal-at-onset headache** (± brief LOC, vomiting, neck stiffness, sentinel
      "warning" headache days earlier). **Don't wait for a stiff neck or a deficit.**
    - **Non-contrast CT first** — near-100% sensitive **within 6 h** of onset.
    - **CT negative but story convincing → LP for xanthochromia** (or CTA) — a normal early CT does
      **not** fully exclude SAH after 6 h.
    - **Confirmed SAH → CTA/DSA to find the aneurysm**, and **transfer to a high-volume
      neurovascular center now** — outcomes are volume- and team-dependent.

## Rapid approach

1. **Diagnose:** non-contrast CT → LP if CT negative and suspicion high → **CTA/DSA** for the aneurysm.
2. **Grade** severity (Hunt-Hess / WFNS) and bleed burden (**modified Fisher** → vasospasm risk).
3. **Prevent re-bleeding** before securing: **control BP**, calm, analgesia, reverse anticoagulation.
4. **Secure the aneurysm within 24 h** — **coil vs clip**, decided by a neurovascular team.
...
1. **CT → (LP if needed) → CTA/DSA**; confirm and localize the aneurysm.
...
!!! orderset "Prevent the re-bleed (highest risk in the first hours)"
...
!!! orderset "Coil vs clip — a neurovascular-team decision, done early"
    - **Endovascular coiling is preferred** when the aneurysm is amenable to both (**ISAT**: better
      functional survival) — especially posterior circulation and older/poorer-grade patients.
    - **Surgical clipping** for wide-neck, large MCA, or clot-with-mass-effect aneurysms, or where
      coiling isn't durable.
    - **Do it within 24 h** at a high-volume center with both capabilities.

## Nimodipine & the delayed-cerebral-ischemia watch

!!! orderset "After securing — the two-week ICU course"
    - **Nimodipine 60 mg PO q4h × 21 days** — **Class 1**; improves outcome (neuroprotective; it does
...
!!! tip "TRICARE — SAH prescribing"
    **Nimodipine is generic/formulary** — the one drug you must not skip. Acute BP agents and reversal
    products are inpatient-stocked. Aneurysm securing (coil/clip) is inpatient neurovascular care.

## Disposition

**High-volume neuro-ICU** with 24-h neurovascular (endovascular **and** neurosurgery) coverage.
Transfer immediately if you can't secure the aneurysm and manage DCI locally. Long rehab and
outpatient aneurysm/imaging follow-up.

!!! military "Military medicine — subarachnoid hemorrhage"
    *Framework — verify against current **AR 40-501**, **DoDI 6130.03**, **DoDI 1332.18**, and JTS
    CPGs before counseling.*
    ...
    - **Screening context:** family history and unruptured-aneurysm findings raise
      counseling/fitness questions — refer to neurovascular.

---

## 📚 Discover — evidence brief

- **Two theaters, weighted equally (2023 AHA/ASA paradigm).** Securing the aneurysm early **and**
  neuro-critical-care management of DCI both determine outcome — manage at high-volume centers.
- **Diagnose fast:** non-contrast CT is near-100% sensitive **<6 h**; after that, **LP for
  xanthochromia** (or CTA) if the story fits. Then CTA/DSA for the aneurysm.
- **Secure within 24 h; coiling is generally preferred** where equivalent (**ISAT**), clipping for
  selected anatomy.
...
1. Hoh BL, et al. [*2023 Guideline for the Management of Patients With Aneurysmal Subarachnoid
   Hemorrhage: AHA/ASA.* Stroke. 2023](https://www.ahajournals.org/doi/10.1161/STR.0000000000000436).
